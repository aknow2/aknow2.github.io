...
window.addEventListener('touchstart', function (e) {
  ...
  if (e.targetTouches.length == 1) {
    ...
    flick.setStart(touch.screenX, touch.screenY);
  }
});
window.addEventListener('touchend', function (e) {
  ...
  if (e.targetTouches.length == 1) {
    var touch = e.targetTouches[0];
    flick.setEnd(touch.screenX, touch.screenY);
  }
});
  ...
  App_createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      logic_Flick.addListener(function (event) {
        ...
        if (event === FlickEvent.up) {
          if (next) {
            _this2.rotate(-60, next);
          }
        } else if (event === FlickEvent.down) {
          if (prev) {
...
//# sourceMappingURL=commons.e1a990ec7e3fecd8faa2.js.map