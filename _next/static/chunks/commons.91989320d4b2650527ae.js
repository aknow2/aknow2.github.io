...
// EXTERNAL MODULE: ./node_modules/@material-ui/core/Card/index.js
var Card = __webpack_require__(229);
var Card_default = /*#__PURE__*/__webpack_require__.n(Card);

// EXTERNAL MODULE: ./node_modules/@material-ui/core/CardActions/index.js
var CardActions = __webpack_require__(231);
var CardActions_default = /*#__PURE__*/__webpack_require__.n(CardActions);

// EXTERNAL MODULE: ./node_modules/@material-ui/core/CardContent/index.js
var CardContent = __webpack_require__(196);
...
// EXTERNAL MODULE: ./node_modules/@material-ui/core/CircularProgress/index.js
var CircularProgress = __webpack_require__(234);
...
// EXTERNAL MODULE: ./node_modules/@material-ui/core/Divider/index.js
var Divider = __webpack_require__(242);
...
var TextField = __webpack_require__(302);
...
var core_styles = __webpack_require__(22);
...
/* harmony default export */ var components_LinkContent = (Object(core_styles["withStyles"])(LinkContent_styles)(LinkContent_LinkContent));
...
function (_React$Component) {
  ...
  _createClass(Top, [{
    ...
    value: function render() {
      ...
      }, "\u3053\u3093\u306B\u3061\u306F\u3002", react["createElement"]("br", null), "\u4E09\u91CD\u770C\u6D25\u5E02\u3067\u50CD\u304F\u30BD\u30D5\u30C8\u30A6\u30A7\u30A2\u958B\u767A\u8005\u3001\u91D1\u5C71\u3067\u3059\u3002", react["createElement"]("br", null), "\uD83D\uDC4D\u30D5\u30ED\u30F3\u30C8\u30A8\u30F3\u30C9\u3001\u30E2\u30D0\u30A4\u30EB\u30FB\u30C7\u30B9\u30AF\u30C8\u30C3\u30D7\u30A2\u30D7\u30EA\u3001\u30AF\u30ED\u30B9\u30D7\u30ED\u30C3\u30C8\u30D5\u30A9\u30FC\u30E0", react["createElement"]("br", null), "\uD83D\uDE0D\u30B5\u30FC\u30D0\u30FC\u30EC\u30B9(\u30AF\u30E9\u30A6\u30C9)\u3001\u30D6\u30ED\u30C3\u30AF\u30C1\u30A7\u30FC\u30F3\u3001\u6A5F\u68B0\u5B66\u7FD2")), react["createElement"](Slide_default.a, {
        direction: 'down',
        in: true
      }, react["createElement"]("div", {
...
var StyledContainer = Object(core_styles["withStyles"])(Top_styles)(Top_Top);
...
var ContentCard_StyledContainer = Object(core_styles["withStyles"])(ContentCard_styles)(ContentCard_ContentCard);
...
var MyPrj_StyledContainer = Object(core_styles["withStyles"])(MyPrj_styles)(MyPrj_MyPrj);
...
var Terms_StyledContainer = Object(core_styles["withStyles"])(Terms_styles)(Terms_Terms);
...
var Policy_StyledContainer = Object(core_styles["withStyles"])(Policy_styles)(Policy_Policy);
...
var TermAndPolicy_StyledContainer = Object(core_styles["withStyles"])(TermAndPolicy_styles)(TermAndPolicy_MyPrj);
...
var Done = __webpack_require__(718);
...
var Contact_styles = function styles(theme) {
  return {
    top: {
      width: '100%'
    },
...
(function (ContactStatus) {
  ContactStatus[ContactStatus["inputting"] = 0] = "inputting";
  ContactStatus[ContactStatus["checking"] = 1] = "checking";
  ContactStatus[ContactStatus["sending"] = 2] = "sending";
  ContactStatus[ContactStatus["recived"] = 3] = "recived";
  ContactStatus[ContactStatus["error"] = 4] = "error";
})(ContactStatus || (ContactStatus = {}));

var validateMail = function validateMail(str) {
  if (str.match(/.+@.+\..+/) == null) {
    return false;
  } else {
    return true;
...
var initState = {
  ...
  subject: '',
  content: '',
  status: ContactStatus.inputting
};

var Contact_Contact =
/*#__PURE__*/
function (_React$Component) {
  Contact_inherits(Contact, _React$Component);
  ...
  function Contact(props) {
    ...
    _this = Contact_possibleConstructorReturn(this, Contact_getPrototypeOf(Contact).call(this, props));

    Contact_defineProperty(Contact_assertThisInitialized(Contact_assertThisInitialized(_this)), "clearForm", function () {
      _this.setState(initState);
    });

    Contact_defineProperty(Contact_assertThisInitialized(Contact_assertThisInitialized(_this)), "stToRecived", function () {
      _this.setState({
        status: ContactStatus.recived
      });
    ...
    Contact_defineProperty(Contact_assertThisInitialized(Contact_assertThisInitialized(_this)), "stToChecking", function () {
      _this.setState({
        status: ContactStatus.checking
      });
    });

    Contact_defineProperty(Contact_assertThisInitialized(Contact_assertThisInitialized(_this)), "stToInputting", function () {
      _this.setState({
        status: ContactStatus.inputting
      });
    });

    Contact_defineProperty(Contact_assertThisInitialized(Contact_assertThisInitialized(_this)), "stToSending", function () {
      _this.setState({
        status: ContactStatus.sending
      });
    });

    Contact_defineProperty(Contact_assertThisInitialized(Contact_assertThisInitialized(_this)), "canSubmit", function () {
      var state = _this.state;
      var validMail = state.validMail;
      var hasContent = state.content.length > 0;
      var hasMail = state.mail.length > 0;
      return validMail && hasContent && hasMail;
    });

    Contact_defineProperty(Contact_assertThisInitialized(Contact_assertThisInitialized(_this)), "setMail", function (event) {
    ...
    Contact_defineProperty(Contact_assertThisInitialized(Contact_assertThisInitialized(_this)), "setName", function (event) {
      event.preventDefault();
    ...
    Contact_defineProperty(Contact_assertThisInitialized(Contact_assertThisInitialized(_this)), "setSubject", function (event) {
      event.preventDefault();
    ...
    Contact_defineProperty(Contact_assertThisInitialized(Contact_assertThisInitialized(_this)), "setContent", function (event) {
      event.preventDefault();
    ...
    Contact_defineProperty(Contact_assertThisInitialized(Contact_assertThisInitialized(_this)), "handleSendContact",
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
    regenerator_default.a.mark(function _callee() {
      var _this$state, content, subject, mail, name, msg, url;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _this$state = _this.state, content = _this$state.content, subject = _this$state.subject, mail = _this$state.mail, name = _this$state.name;
              ...
              url = "https://us-central1-aknow2-contact.cloudfunctions.net/contact ";
  ...
  Contact_createClass(Contact, [{
    ...
    value: function render() {
      ...
      return react["createElement"]("div", {
      ...
      }, react["createElement"](Card_default.a, {
        className: classes.card
      }, react["createElement"](CardContent_default.a, {
        className: classes.cardContent
      }, react["createElement"](TextField_default.a, {
        disabled: status !== ContactStatus.inputting,
        ...
        margin: "normal",
        value: content
      }), status === ContactStatus.checking && react["createElement"]("div", null, react["createElement"](Divider_default.a, null), react["createElement"](Typography_default.a, null, "\u4E0A\u8A18\u5185\u5BB9\u3067\u9001\u4FE1\u3057\u3066\u3082\u3088\u308D\u3057\u3044\u3067\u3057\u3087\u3046\u304B\uFF1F")), status === ContactStatus.sending && react["createElement"]("div", {
        className: classes.cardaction
      }, react["createElement"](Divider_default.a, null), react["createElement"](Typography_default.a, null, "\u9001\u4FE1\u4E2D")), status === ContactStatus.recived && react["createElement"]("div", {
        className: classes.cardaction
      }, react["createElement"](Divider_default.a, null), react["createElement"](Typography_default.a, null, "\u304A\u554F\u3044\u5408\u308F\u305B\u3042\u308A\u304C\u3068\u3046\u3054\u3056\u3044\u307E\u3059\u3002", react["createElement"]("br", null), "3\u65E5\u4EE5\u5185\u306B\u304A\u8FD4\u4E8B\u81F4\u3057\u307E\u3059\u3002"))), react["createElement"](CardActions_default.a, null, status === ContactStatus.inputting && react["createElement"](Button_default.a, {
        className: classes.textField,
        color: "primary",
        variant: "raised",
        disabled: !this.canSubmit(),
        onClick: this.stToChecking
      }, "\u9001\u4FE1"), status === ContactStatus.checking && react["createElement"]("div", null, react["createElement"](Button_default.a, {
        className: classes.textField,
        onClick: this.stToInputting
      }, "\u623B\u308B"), react["createElement"](Button_default.a, {
        className: classes.textField,
        color: "primary",
        variant: "raised",
        onClick: this.handleSendContact
      }, "\u9001\u4FE1\u3059\u308B")), status === ContactStatus.sending && react["createElement"]("div", {
        className: classes.cardaction
      }, react["createElement"](CircularProgress_default.a, null)), status === ContactStatus.recived && react["createElement"]("div", {
        className: classes.cardaction
      }, react["createElement"](Done_default.a, {
        color: "secondary"
      }), react["createElement"](Typography_default.a, null, "\u53D7\u4ED8\u5B8C\u4E86"))))));
    }
  }]);
...
var Contact_StyledContainer = Object(core_styles["withStyles"])(Contact_styles)(Contact_Contact);
/* harmony default export */ var components_Contact = (Contact_StyledContainer);
// CONCATENATED MODULE: ./components/logic/Flick.ts
function Flick_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function Flick_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function Flick_createClass(Constructor, protoProps, staticProps) { if (protoProps) Flick_defineProperties(Constructor.prototype, protoProps); if (staticProps) Flick_defineProperties(Constructor, staticProps); return Constructor; }

function Flick_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

var FlickEvent;

(function (FlickEvent) {
  FlickEvent["down"] = "down";
  FlickEvent["up"] = "up";
  FlickEvent["none"] = "none";
...
function () {
  function Flick() {
    Flick_classCallCheck(this, Flick);

    Flick_defineProperty(this, "startpos", {
      x: 0,
      y: 0
    });

    Flick_defineProperty(this, "endPos", {
      x: 0,
      y: 0
    });

    Flick_defineProperty(this, "listeners", []);
  }

  Flick_createClass(Flick, [{
    key: "addListener",
    value: function addListener(listener) {
      ...
      window.addEventListener('touchstart', function (e) {
        if (e.targetTouches.length == 1) {
          ...
          _this.setStart(touch.screenX, touch.screenY);
        }
      });
      window.addEventListener('touchend', function (e) {
        if (e.changedTouches.length == 1) {
          ...
          _this.setEnd(touch.screenX, touch.screenY);
        }
      });
    }
  }, {
    ...
    value: function judge() {
      ...
      var result = function () {
        var delta = Math.abs(s.y - e.y);

        if (delta > 15) {
          if (s.y > e.y) {
            return FlickEvent.down;
          } else {
            return FlickEvent.up;
          }
        } else {
          return FlickEvent.none;
        }
      }();
...
var flick = new Flick();
/* harmony default export */ var logic_Flick = (flick);
...
(function (InitPos) {
  ...
  InitPos[InitPos["contact"] = 120] = "contact";
  InitPos[InitPos["tp"] = 180] = "tp";
})(InitPos || (InitPos = {}));
...
function (_React$Component) {
  ...
  function App(props) {
    ...
    App_defineProperty(App_assertThisInitialized(App_assertThisInitialized(_this)), "toContact", function () {
      _this.closeMenu();

      var deltaX = -1 * _this.state.contact.x;

      _this.rotate(deltaX, '/contact');
    });
  ...
  App_createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      logic_Flick.addListener(function (event) {
        var routeList = ['/', '/prj', '/contact', '/terms'];

        var getUDRoute = function getUDRoute() {
          var x = _this2.state.top.x;
          var current = x;

          for (var i = 0; i < routeList.length; i++) {
            if (current === 0) {
              if (i === 0) {
                return [null, routeList[i + 1]];
              } else if (i === routeList.length - 1) {
                return [routeList[i - 1], null];
              }

              return [routeList[i - 1], routeList[i + 1]];
            }
        ...
        var _getUDRoute = getUDRoute(),
            _getUDRoute2 = _slicedToArray(_getUDRoute, 2),
            prev = _getUDRoute2[0],
            next = _getUDRoute2[1];

        if (event === FlickEvent.down) {
          if (next) {
            _this2.rotate(60, next);
          }
        } else if (event === FlickEvent.up) {
          if (prev) {
            _this2.rotate(-60, prev);
          }
        }
      });
    }
    ...
    value: function render() {
      ...
      return react["createElement"]("div", {
        ...
        className: classes.surface + ' ' + classes.contact,
        style: contact.style
      }, react["createElement"](components_Contact, {
        next: this.toTerms,
      ...
      }, "Contact"), react["createElement"](Button_default.a, {
        style: {
          color: '#c0c0c0',
          fontSize: 48
        },
...
/* harmony default export */ var components_App = __webpack_exports__["b"] = (Object(core_styles["withStyles"])(App_styles)(App_App));
...
var _CardContent = _interopRequireDefault(__webpack_require__(477));
...
var _Card = _interopRequireDefault(__webpack_require__(571));
...
var _CardActions = _interopRequireDefault(__webpack_require__(573));
...
var _CircularProgress = _interopRequireDefault(__webpack_require__(576));
...
var _Divider = _interopRequireDefault(__webpack_require__(584));
...
var _FilledInput = _interopRequireDefault(__webpack_require__(591));
...
var _FormControl = _interopRequireDefault(__webpack_require__(592));
...
var _FormHelperText = _interopRequireDefault(__webpack_require__(598));
...
var _FormLabel = _interopRequireDefault(__webpack_require__(599));
...
var _Grow = _interopRequireDefault(__webpack_require__(602));
...
var _Input = _interopRequireDefault(__webpack_require__(606));
...
var _InputBase = _interopRequireDefault(__webpack_require__(608));
...
var _InputLabel = _interopRequireDefault(__webpack_require__(611));
...
var _List = _interopRequireDefault(__webpack_require__(614));
...
var _MenuList = _interopRequireDefault(__webpack_require__(625));
...
var _OutlinedInput = _interopRequireDefault(__webpack_require__(630));
...
var _Popover = _interopRequireDefault(__webpack_require__(631));
...
var _TextField = _interopRequireDefault(__webpack_require__(660));
...
var _InputBase = _interopRequireDefault(__webpack_require__(261));
...
var _utils2 = __webpack_require__(610);
...
var _FormControlContext = _interopRequireDefault(__webpack_require__(593));
...
var _formControlState = _interopRequireDefault(__webpack_require__(594));

var _withFormControlContext = _interopRequireDefault(__webpack_require__(595));
...
var _Textarea = _interopRequireDefault(__webpack_require__(609));
...
var _ListContext = _interopRequireDefault(__webpack_require__(615));
...
var _Popover = _interopRequireDefault(__webpack_require__(278));

var _MenuList = _interopRequireDefault(__webpack_require__(274));
...
var _List = _interopRequireDefault(__webpack_require__(265));
...
var _NativeSelectInput = _interopRequireDefault(__webpack_require__(628));
...
var _ArrowDropDown = _interopRequireDefault(__webpack_require__(680));

var _Input = _interopRequireDefault(__webpack_require__(259));
...
var _NotchedOutline = _interopRequireDefault(__webpack_require__(629));
...
var _SelectInput = _interopRequireDefault(__webpack_require__(636));
...
var _NativeSelect = __webpack_require__(627);
...
var _Menu = _interopRequireDefault(__webpack_require__(623));
...
var _FilledInput = _interopRequireDefault(__webpack_require__(249));

var _OutlinedInput = _interopRequireDefault(__webpack_require__(277));

var _InputLabel = _interopRequireDefault(__webpack_require__(262));
...
var _Select = _interopRequireDefault(__webpack_require__(282));
...
//# sourceMappingURL=commons.91989320d4b2650527ae.js.map